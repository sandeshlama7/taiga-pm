...
#   value       = compact(aws_vpc_ipv4_cidr_block_association.main[*].cidr_block)
# }
...
output "vpc_flow_log_cloudwatch_iam_role_arn" {
  description = "The ARN of the IAM role puch logs to Cloudwatch log group"
...
output "azs" {
  description = "A list of availability zones specified as argument to main module"
  value       = var.azs
}

output "name" {
  description = "The name of the VPC specified as argument to main module"
  value       = var.name
}
